...
user did not authorize web access or a provider change. The user also requested
Cursor with a separate `reasoning_effort: high` value but did not choose a
compatible effort-bearing model ID.
