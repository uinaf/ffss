...
func runConfig(ctx context.Context, arguments []string, stdout, stderr io.Writer, dependencies dependencies) int {
	...
	if flags.NArg() != 0 {
		report(stderr, "slopguard config does not accept positional arguments\n")
		return 2
	}
