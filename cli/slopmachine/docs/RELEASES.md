...
the binary and exits 4 when an update is available. It shares the Linux
...
cosign verify-blob \
  ...
  --certificate-identity \
    "https://github.com/uinaf/ffsstack/.github/workflows/release-slopmachine.yml@refs/heads/main" \
